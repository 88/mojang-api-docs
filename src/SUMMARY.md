...
- [No authentication](./no-auth/index.md)
    ...
    - [Username availability (partially accurate)](./no-auth/username-availability-partially-accurate.md)
...
- [Requires authentication](./needs-auth/index.md)
    ...
    - [Check if you own a copy of Minecraft](./needs-auth/check-if-owns-minecraft.md)
...
- [Microsoft account migration](./msa-migration/index.md)
    - [Check migration status](./msa-migration/migration-status.md)
    - [Get migration token](./msa-migration/migration-token.md)
    - [Validate a MSA token](./msa-migration/validate-msa-token.md)
    - [Link an account](./msa-migration/link-msa.md)
